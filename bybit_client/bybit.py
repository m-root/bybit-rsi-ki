...
# api_key = 'OjtmGR4D1zP2ya2tLp'
# secret_key = '4WPwKWD5uGxTCnOhtSc2uR0ZgoAdeUvMmvME'
#
# client  = Account( api_key=api_key, secret_key=secret_key)
# print(client.wallet_balance('BTC'))
# print(client.ticker('BTCUSDT'))
# from core import ticker
# print(
#     ticker.ticker(rest_client=client, pair='BTCUSDT')[0]
# )
# print(client.api_key_info())
#
# from core import candle
# print(candle.candles(symbol="BTCUSD", interval=360, rest_client=client))
